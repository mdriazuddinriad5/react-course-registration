...
const Carts = ({ cartTitle, courseCredit, coursePrice }) => {
    ...
    return (
        <div className="w-1/4 bg-[#FFF] px-6 pb-6 h-full">
            <h2 className="text-xl mt-6 text-[#2F80ED] font-bold text-lg">Credit Hour Remaining {20-courseCredit} hr</h2>
            ...
            {cartTitle.length > 0 ? <h2 className="my-4 text-[#1C1B1BCC] text-base font-medium">Total Credit Hour: {/* {courseCredit<= 20 ? courseCredit : null } */ courseCredit}</h2> : null}
